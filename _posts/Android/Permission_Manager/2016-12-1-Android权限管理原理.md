...
>  Android6.0动态权限持久化    
>  Android6.0开机权限恢复     
>  Android6.0普通权限的申请(直接是权限申请成功的回调)
...
![](https://github.com/happylishang/happylishang.github.io/blob/master/images/android/pkms/before_6.0_request.png?raw=true)
