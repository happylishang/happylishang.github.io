...
熟悉在Google Play上应用从申请，开发，审核的必要流程，并具备一定的实际经验；主导Android平台软件框架的研究，设计和实现、关键技术验证和选型等工作；带领并指导开发工程师、程序员进行代码开发/单元测试等工作；负责技术规范制订、组织技术文档编写；对潜在的技术难点开展调研，提供完善的解决方案；分享项目开发中的问题和解决方案，带领新人完成相关工作；配合项目经理，把控项目质量、时间风险，积极协调资源保证项目的顺利进行；把握移动技术的发展方向，调动组内成员进行学习交流；跟踪业界先进技术与解决方案，并能运用到产品中
