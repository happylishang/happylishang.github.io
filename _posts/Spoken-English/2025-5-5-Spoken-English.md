...
*    I don’t know what you mean.（最常用、自然） 	
*     I’m not sure what you mean.（口语化，也很常用）
...
##  过去式一般会隐含某个发生的事件，即使米说出来
 
I got married ✅
→ 强调的是 结婚这个动作发生了，通常指在某个时间点发生的事。
比如：I got married last year.（我去年结婚了。）
...
你要说的是 什么时候结婚的 → 用 过去式、你要**强调 现在已经结婚了（状态/结果）** → 用 完成式 或者更自然的 I’m married
