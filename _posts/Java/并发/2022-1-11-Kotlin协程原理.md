...
可以看到是需要挂起的，等待回调，回调传入的还有父级协程的this，不过DeferredCoroutine是如何跟当前的节点衔接起来的呢？
...
ResumeAwaitOnCompletion 的invoke    
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5fabe08997e34f2594f45fa30a1778bb~tplv-k3u1fbpfcp-watermark.image?)
